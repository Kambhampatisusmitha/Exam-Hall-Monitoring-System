...
def register_page():
    ...
    with st.form(key="register_form"):
        ...
        role = col1.selectbox("Role", ["Staff", "Administrator"])
        branch = col2.selectbox("Branch", ["CSE", "ECE", "EEE", "MECH", "CIVIL", "IT", "AIDS", "BIO-TECH", "CHEMICAL", "MME", "MATHS", "PHYSICS", "CHEMISTRY", "ENGLISH", "MBA", "MCA", "PHD", "M.Tech", "M.Sc", "M.Phil", "Others"])
        col1, col2 = st.columns(2)
        ...
        if register_button:
            ...
            if not re.match(email_regex, email):
                ...
                if register_user(name, email, role, branch, password):
